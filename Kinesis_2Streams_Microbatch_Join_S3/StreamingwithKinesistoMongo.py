...
def processBatch(data_frame, batchId):
    if data_frame.count() > 0:
        ...
        dataframe_AmazonKinesis_jointmp_df2 = dataframe_AmazonKinesis_2.toDF()
        
        dataframe_AmazonKinesis_jointmp_df2 = dataframe_AmazonKinesis_jointmp_df2.select("snsid", "currenttem", "sts")
        
        joined_dataframe = dataframe_AmazonKinesis_jointmp_df1.join(dataframe_AmazonKinesis_jointmp_df2, expr("sensorid = snsid"))
